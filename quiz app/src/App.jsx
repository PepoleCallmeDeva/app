...
import Geography_Static from './components/Geography_Static'
const App = () => {
  return (
    <div>
     <BrowserRouter>
     <Routes>
      ...
      <Route element={<Modern_India/>} path='/Modern_India/:id'/>
      <Route element={<Geography_Static/>} path='/Geography_static/:id'/>
     </Routes>
     </BrowserRouter>
      </div>
  )
