...
console.log(data[index]);
  return (
    <div className={style.container}>
        <h1>{obj.id}</h1>
        {res?<><h2>you had {score} out of {data.length} <br /><Link to='/Polity/Polity' style={ba}}><button>reset</button></Link></h2></>:<><h2>{index + 1}.{ques.Questions}- <span>{ques['asked in']}</span></h2>
        <ul>
