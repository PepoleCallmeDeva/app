...
const Polity = () => {
    ...
    const checkAns=(e)=>{
      if(e.target.value===ques['correct answer']){
        console.log('correct');
      }
      else
    }
  return (
    <div className={style.container}>
      ...
      <ul>
        <li onClick={checkAns}>{ques.A}</li>
        <li onClick={checkAns}>{ques.B}</li>
        <li onClick={checkAns}>{ques.C}</li>
        <li onClick={checkAns}>{ques.D}</li>
        <button>next</button>
      </ul>
