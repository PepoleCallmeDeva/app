...
const Polity = () => {
  ...
  return (
    <div className={style.container}>
      ...
      <ul>
        <li onClick={checkAns} value={ques}>{ques.A}</li>
        <li onClick={checkAns} value={ques}>{ques.B}</li>
        <li onClick={checkAns} value={ques}>{ques.C}</li>
        <li onClick={checkAns} value={ques}>{ques.D}</li>
        <button>next</button>
      </ul>
