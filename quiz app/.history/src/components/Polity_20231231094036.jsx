...
const Polity = () => {
  ...
  return (
    <div className={style.container}>
      ...
      <ul>
        <li onClick={checkAns} value={qu}>{ques.A}</li>
        <li onClick={checkAns} value={qu}>{ques.B}</li>
        <li onClick={checkAns} value={qu}>{ques.C}</li>
        <li onClick={checkAns} value={qu}>{ques.D}</li>
        <button>next</button>
      </ul>
