...
const Polity = () => {
  ...
  return (
    <div className={style.container}>
        ...
        <ul>
          <li ref={} onClick={(e) => { checkAns(e, 1) }} >{ques.A}</li>
          <li ref={} onClick={(e) => { checkAns(e, 2) }} >{ques.B}</li>
          <li ref={} onClick={(e) => { checkAns(e, 3) }} >{ques.C}</li>
          <li ref={} onClick={(e) => { checkAns(e, 4) }} >{ques.D}</li>
          <button>next</button>
        </ul>
