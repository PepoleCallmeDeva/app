...
const Polity = () => {
  ...
  return (
    <div className={style.container}>
      ...
      <ul>
        <li onClick={(e)=>{checkAns(e,ques.)}} >{ques.A}</li>
        <li onClick={(e)=>{checkAns(e,ques)}} >{ques.B}</li>
        <li onClick={(e)=>{checkAns(e,ques)}} >{ques.C}</li>
        <li onClick={(e)=>{checkAns(e,ques)}} >{ques.D}</li>
        <button>next</button>
      </ul>
